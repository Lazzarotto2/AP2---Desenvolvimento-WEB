...
const verificaSenha = () => {
    ...
    const senha = "59c249f4c235fdbc552c1cf3214018907eacb27d17ea950a29e18d14d2110e4d"
...
if(sessionStorage.getItem("logado")){
    ...
    function barrachataprakrl(){
        container.innerHTML = '';
        const naoaguentomaiscodar = document.getElementById("queriatalendolivro")
        apletas.forEach((atleta) => {
            if (atleta.nome.toUpperCase().includes(naoaguentomaiscodar.value.toUpperCase())){
                montaCard(atleta)
            }
        })
    }
